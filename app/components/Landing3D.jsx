...
const Landing3D = () => {
  ...
  useEffect(() => {
    ...
    initializeScene(new THREE.TextureLoader().load(image.src));
    animateScene();
  ...
  return (
    <div id="img3d" className="flex justify-center items-center">
      <div
        ...
        className="relative md:max-h-[768px] w-fit md:w-[768px] flex justify-center items-center h-[90vh] "
      >
        <img src={image.src} alt="image" className="h-[0px] w-[0px]" />
      </div>
    </div>
  );
};
